...
// Using prototype keyword to add 'pool' property to function object Base's prototype.
Base.prototype.pool = mysql.createPool({
  host     : 'localhost',
  user     : 'root',
  password : 'root',
...
Base.formatSQL = function(sql,values){
...
SQLBuilder.prototype.from = function(table){
    ...
    this.table = "transfermarket."+table;
    return this;
}
...
Base.prototype.execute  = function(sql, values, callback){
    if(values){
...
Base.prototype.find = function(columns, query, orderBy, limit, offset, callback){
...
Base.prototype.findByPage = function(columns, query, orderBy, page, count, callback){
    page = page?page:1;
    count= count?count:5;
    var limit = count;
...
Base.prototype.findOne = function(columns, query, callback){
...
Base.prototype.findAll = function(columns, orderBy, callback){
